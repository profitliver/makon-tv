        ...
        <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      <Card className="bg-dark-300 border-dark-50/20">
                                <CardHeader>
                                            <CardTitle className="text-white">Быстрые действия</CardTitle>CardTitle>
                      ...
                      <Card className="bg-dark-300 border-dark-50/20">
                                <CardHeader>
                                            <CardTitle className="text-white">Информация</CardTitle>CardTitle>
                                </CardHeader>CardHeader>
                                <CardContent>
